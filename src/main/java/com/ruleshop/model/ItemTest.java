...
public class ItemTest implements Serializable {
    ...
    public ItemTest(String name, Double cost, Double salePrice) {
        this(null, name, cost, salePrice);
    }

    public ItemTest(Long id, String name, Double cost, Double salePrice) {
        this.id = id;
        this.name = name;
        this.cost = cost;
    ...
    public boolean equals(Object obj) {
        ...
        final ItemTest other = (ItemTest) obj;
